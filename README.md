...
Setting oauth2 basic secret values to any random string might lead to validation issues, 
see [this issue for more details](https://github.com/oddlama/kanidm-provision/issues/16).
To prevent this problem, generate new secret values from this shell oneliner:  
```
